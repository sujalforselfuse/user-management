...
export default function Navbar() {
    return (
        <div className='flex gap-8 items-center justify-end mr-4 mt-2'>
            <div>
            ...
            <div>
                <img className='w-12 h-12 rounded-full' src='https://d2qp0siotla746.cloudfront.net/img/use-cases/profile-picture/template_0.jpg' alt="" srcset="" />
            </div>
            <div className='bg-blue-400 p-2 rounded-md'>Logout</div>
        </div>
    )
}
